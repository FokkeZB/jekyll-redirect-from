...
describe JekyllRedirectFrom::RedirectPage do
  ...
  context "#generate_redirect_content" do
    it "sets the #content to the generated refresh page" do
      expect(page_content).to eq("<!DOCTYPE html>\n<html lang=\"en-US\">\n<meta charset=\"utf-8\">\n<title>Redirecting…</title>\n<link rel=\"canonical\" href=\"#{item_url}\">\n<meta id=\"refresh\" http-equiv=\"refresh\" content=\"1; url=#{item_url}\">\n<h1>Redirecting…</h1>\n<a id=\"a\" href=\"#{item_url}\">Click here if you are not redirected.</a>\n<script>\n  var add = '';\n  if (location.search) {\n    add += location.search; \n  }\n  if (location.hash) {\n    add += location.hash; \n  }\n  if (add) {\n    var refresh = document.getElementById('refresh');\n    refresh.content += add;\n    var a = document.getElementById('a');\n    a.href += add;\n  }\n  location.replace(\"#{item_url}\" + add);\n</script>\n</html>\n")
    end

    it "contains the meta refresh tag" do
      expect(page_content).to include("<meta id=\"refresh\" http-equiv=\"refresh\" content=\"1; url=#{item_url}\">")
    end
    ...
    it "contains a clickable link to redirect" do
      expect(page_content).to include("<a id=\"a\" href=\"http://jekyllrb.com/2014/01/03/moving-to-jekyll.md\">Click here if you are not redirected.</a>")
    end
  end
